            ...
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered">
                        ...
                        @foreach($subcategories as $subcategory)
                            <tr>
                                ...
                                <td> {{$subcategory->subcategory_vn}}</td>
                                <td>
                                    <a href="{{route('edit.subcategory',$subcategory->id)}}"
                                       class="btn btn-info">Edit</a>
                                    <form action="{{route('destroy.subcategory',$subcategory->id)}}" method="POST"
                    ...
                    <div style="margin-top: 10px">
                        {!! $subcategories->appends(request()->all())->links('pagination::bootstrap-4') !!}
